        ...
        <Col xs={24} xl={12}>
          <div className="offlineClass-about">
            ...
            <p style={{ fontSize: "14px" }}>
              Program belajar tari tradisional adalah sebuah kesempatan untuk
              mempelajari dan menghayati keindahan budaya Indonesia melalui
              gerakan-gerakan yang khas dan simbolis. Dalam program ini, peserta
              akan diajarkan langkah-langkah dasar, teknik gerakan, serta makna
              di balik setiap gerakan dalam tari tradisional.
            </p>
          </div>
        </Col>
      </Row>
